...
When a potential validator becomes an active validator, it can start producing blocks. If the validator successfully produces blocks without forking or [delaying](/docs/view-change) the blockchain, it will be rewarded at the macro block of the next batch.
...
For a detailed explanation about the supply formula to calculate the coinbase: [click here](/docs/supply-formula).
