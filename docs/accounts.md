...
For a detailed explanation about the staking contract, follow this [link](/albatross-doc/docs/staking-contract) to read on validators, stakers, and their interactions with the staking contract.
